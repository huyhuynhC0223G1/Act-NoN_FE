        ...
        <div>
            <nav className="navbar fixed-top navbar-expand-lg container-fluid p-4">
                <div className="container-fluid">
                    <a className="navbar-brand" href="#"><img src="../../public/Screenshot 2023-10-03 160714.png" alt="logo"/></a>
                    ...
                    <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvasNavbar"
                        ...
                        <div className="offcanvas-body">
                            <ul className="navbar-nav align-items-center justify-content-end justify-content-xxl-center flex-grow-1 pe-3">
                                ...
                                <li className="nav-item">
                                    <a href="https://templatesjungle.gumroad.com/l/turbo-car-wash-bootstrap-website-template"
                                       className="btn btn-outline-primary mx-2 px-3 py-2">Get pro
            ...
            <section id="hero" style={{backgroundImage: 'url(https://i.pinimg.com/originals/23/ea/fe/23eafe44f1d4782b3a2f6fbf9c9b891c.jpg)', }}>
                        ...
                        <div className="container">
                            <div className="row align-items-center ">
                                ...
                                <div className="col-md-6 padding-medium-2 ps-md-5">
                                    <p className="ms-md-5 ">Odio a faucibus cras lacus felis in enim. In tincidunt in
                                        tortor ligula
                                        risus
                                        nulla
                                        blandit. Et augue sed urna nisi augue. Amet nisi iaculis suspendisse fermentum
                                        curabitur
                                        feugiat. Velit sed ante in nisl amet sapien. Mauris a ullamcorper ut iaculis. Et
                                        massa
                                        non
                                        eu ac
                                        tristique egestas consectetur.
                                    </p>
                                    <a href="about.html" className="btn btn-primary ms-5 mt-3 ">About us <iconify-icon
                        ...
                        <div className="row">
                            <div className="col-md-6 col-lg-3">
                                <div className="py-3 py-md-5 px-3">
                                    ...
                                    <p>Eget magna fermentum iaculis diam phasellus vestibulum lorem eget mauris pharetra
                                        et.
                                    </p>
                                </div>
                            </div>
                            <div className="col-md-6 col-lg-3">
                                <div className="py-3 py-md-5 px-3">
                                    ...
                                    <p>Velit sed ante in nisl amet sapien. Mauris a ullamcorper ut iaculis. Et massa non
                                        eu ac
                                        tristique.
                                    </p>
                                </div>
                            ...
                            <div className="col-md-6 col-lg-3">
                                <div className="py-3 py-md-5 px-3">
                                    ...
                                    <p>In tincidunt in tortor ligula risus nulla blandit eget mauris ete pharetraeget
                                        etem.</p>
                                </div>
                            </div>
                            <div className="col-md-6 col-lg-3">
                            ...
                            <div className="swiper project-swiper mb-4">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="item">
                                            <a href="actnon_fe/public/images/project1.jpg" title="Car Wash" className="image-link">
                                                <img className="portfolio-img img-fluid" src="actnon_fe/public/images/project1.jpg"
                                                     alt=""/>
                                                <div
                                    ...
                                    <div className="swiper-slide">
                                        <div className="item">
                                            <a href="actnon_fe/public/images/project2.jpg" title="Car Wash" className="image-link">
                                                <img className="portfolio-img img-fluid" src="actnon_fe/public/images/project2.jpg"
                                                     alt=""/>
                                                <div
                                                    className="description position-absolute top-50 start-50 translate-middle text-center p-3">
                                                    <p className="text-white">BMW Car</p>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="item">
                                            <a href="actnon_fe/public/images/project3.jpg" title="Car Wash" className="image-link">
                                                <img className="portfolio-img img-fluid" src="actnon_fe/public/images/project3.jpg"
                                                     alt=""/>
                                                <div
                                                    className="description position-absolute top-50 start-50 translate-middle text-center p-3">
                                                    <p className="text-white">BMW Car</p>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="item">
                                            <a href="actnon_fe/public/images/project4.jpg" title="Car Wash" className="image-link">
                                                <img className="portfolio-img img-fluid" src="actnon_fe/public/images/project4.jpg"
                                                     alt=""/>
                                                <div
                                                    className="description position-absolute top-50 start-50 translate-middle text-center p-3">
                                                    <p className="text-white">BMW Car</p>
                                    ...
                                    <div className="swiper-slide">
                                        <div className="item">
                                            <a href="#" title="Car Wash" className="image-link">
                                                <img className="portfolio-img img-fluid" src="actnon_fe/public/images/project3.jpg"
                                                     alt=""/>
                                                <div
                                                    className="description position-absolute top-50 start-50 translate-middle text-center p-3">
                        ...
                        <ul className="nav nav-tabs my-3" id="myTab" role="tablist">
                            <li className="nav-item" role="presentation">
                                <button className="nav-link me-4 px-4 py-1 mb-2 active" id="regular-tab"
                                        data-bs-toggle="tab" data-bs-target="#regular-tab-pane" type="button" role="tab"
                                        aria-controls="regular-tab-pane" aria-selected="true">regular
                                </button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link me-4 px-4 py-1 mb-2" id="medium-tab" data-bs-toggle="tab"
                                        data-bs-target="#medium-tab-pane" type="button" role="tab"
                                        aria-controls="medium-tab-pane" aria-selected="false">medium
                                </button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link me-4 px-4 py-1 mb-2" id="van-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="van-tab-pane" aria-selected="false">mini van
                                </button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link me-4 px-4 py-1 mb-2" id="truck-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="truck-tab-pane" aria-selected="false">pickup
                                    truck
                                </button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link me-4 px-4 py-1 mb-2" id="cargo-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="cargo-tab-pane" aria-selected="false">cargo
                                    truck
                                </button>
                            </li>
                        </ul>
                ...
                <div style={{overflow: 'hidden'}}>
                    <div className="video-content position-relative open-up" data-aos="zoom-out">
                        <div className="video-bg">
                            <img src="actnon_fe/public/images/vid-img.jpg" alt="video" className="video-image img-fluid"/>
                        </div>
                ...
                <div className="container footer-containerG mt-5 mt-md-0 pt-3">
                    <footer className="row row-cols-1 row-cols-sm-2 row-cols-md-5 my-5 py-5 ">
                        <div className=" col-md-3 my-5 mt-md-0 ">
                            <img src="actnon_fe/public/images/logo-dark.png" alt="" className/>
                            <p className="my-4">Velit sed ante in nisl amet sapien. Mauris a ullamcorper ut iaculis. Et
                                massa non eu
                                ac tristique assa non eu ac tristique.</p>
                            <div className="d-flex align-items-center ">
                                <a href="#" target="_blank">
                                    <iconify-icon className="social-icon-footer active pe-4" icon="mdi:facebook"/>
                                </a>
                                <a href="#" target="_blank">
                                    <iconify-icon className="social-icon-footer pe-4" icon="mdi:twitter"/>
                                </a>
                                <a href="#" target="_blank">
                                    <iconify-icon className="social-icon-footer pe-4" icon="mdi:instagram"/>
                                </a>
                                <a href="#" target="_blank">
                                    <iconify-icon className="social-icon-footer pe-4" icon="mdi:linkedin"/>
                                </a>
                                <a href="#" target="_blank">
                                    <iconify-icon className="social-icon-footer pe-4" icon="mdi:youtube"/>
                                </a>
                            </div>
                        </div>
                        <div className="col-md-2 offset-md-1">
                            ...
                            <ul className="navbar-nav flex-column">
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">About
                                    us</a>
                                </li>
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">WHo
                                    are
                                    we</a>
                                </li>
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">Why
                                    choose us</a>
                                </li>
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">Our
                                    history</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-md-2">
                            ...
                            <ul className="navbar-nav flex-column">
                                ...
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">Tiring
                                    dressing</a>
                                </li>
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">Wheel
                                    shine</a>
                                </li>
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">Interior
                                    vacuum</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-md-2 ">
                            ...
                            <ul className="navbar-nav flex-column">
                                ...
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">Contact</a>
                                </li>
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">Address</a>
                                </li>
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">Facebook</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-md-2 ">
                            ...
                            <ul className="navbar-nav flex-column">
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">VEhicle</a>
                                </li>
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">bike</a>
                                </li>
                                <li className="nav-item footer-list mb-3"><a href="#"
                                                                             className="nav-link text-uppercase p-0 ">Scooter</a>
                                </li>
                            </ul>
                        </div>
                    </footer>
                ...
                <div className="container">
                    <footer className="d-flex flex-wrap justify-content-between align-items-center py-2 pt-4">
                        ...
                        <div className="col-md-6 d-flex align-items-center justify-content-end">
                            <p className>© 2023 Designed By:<a href="https://templatesjungle.com/"
                                                               className="website-link text-decoration-none"
                                                               target="_blank"> <b>TemplatesJungle</b></a></p>
                        </div>
                    </footer>
                </div>
            </section>
